...
class ConModelsController: NSObject {
    ...
    private lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Naga-Softworks.DummyCoreData" in the application's documents Application Support directory.
